...
date: 2015-08-23
tags: code
description: 本文记录了笔者在使用ionic开发移动app过程中，地址选择部分涉及省市县三级联动部分的代码。
---
...
<body>
	<div ng-controller="demo">
		<div>
			...
			<select ng-model="city" ng-options="cit.name for cit in cities" ng-change="cityToArea()"></select>
			<select ng-model="area" ng-options="are for are in areas"></select>
		</div>
	</div>
<script>
