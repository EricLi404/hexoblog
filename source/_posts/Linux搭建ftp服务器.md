...
date: 2015-09-14
tags: Linux
description: 本文记录了笔者在阿里云  Ubuntu server 搭建 ftp 服务器的过程。
---
...
2. 新建ftp用户user，用于远程登陆ftp
------------------------

```
sudo mkdir /home/user     #新建用户文件夹

sudo useradd -d /home/user -s /bin/bash user   #新建用户

sudo passwd user         #为新建的用户添加密码
```
